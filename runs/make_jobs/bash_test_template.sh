...
singularity exec -B /cluster:/cluster $SINGULARITY_IMAGE /bin/bash -c "source /usr/local/root/bin/thisroot.sh && ${WILKS} ${ARGS} -m test >> @@dir@@/runs/joblogs_@@outdir@@/output_m41_@@begin@@_@@end@@_um4_@@um4@@_ue4_@@ue4@@_@@tag@@.txt"
